    ...
    try:
        ...
        if choice == 'y':
            ...
            sample_data = [
                ...
                ['P002', '수학', '중2', '주관식', '중', '다음 방정식을 풀어보세요: 2x + 5 = 15', 
                 '', '', '', '', '', '5', '방정식,일차방정식', 'x = (15-5)/2 = 10/2 = 5'],
                ['P003', '과학', '고1', '객관식', '상', '다음 중 산성 물질은?', 
                 '식초', '소다', '비누', '바닷물', '', '1', '산성,알칼리', '식초는 pH가 낮은 산성 물질입니다.'],
                ['P004', '국어', '중3', '객관식', '하', '다음 중 맞춤법이 올바른 것은?', 
                 '됬다', '됐다', '되었다', '되엇다', '', '2', '맞춤법,된소리', '\'됐다\'는 \'되었다\'의 준말로 올바른 맞춤법입니다.'],
                ['P005', '사회', '고2', '주관식', '중', '대한민국의 수도는?', 
                 '', '', '', '', '', '서울', '수도,대한민국', '대한민국의 수도는 서울입니다.']
            ]
